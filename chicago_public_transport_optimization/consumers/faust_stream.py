...
async def transformedstation(stationevents):
    ...
    #
    async for transfstation in stationevents.group_by(Station.station_id):
        #
        ...
        if transfstation.red:
            table[transfstation.line] = "red"
        elif transfstation.blue:
            table[transfstation.line] = "blue"
        elif transfstation.green:
            table[transfstation.line] = "green"
