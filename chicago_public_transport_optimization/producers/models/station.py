...
class Station(Producer):
    ...
    #
    logger.info("Loading value schema: "+str(f"{Path(__file__).parents[0]}/schemas/arrival_value.json"))
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        topic_name = "org.chicago.cta.arrivals.v1" # TODO: Come up with a better topic name
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        #
        #
        logger.info("Running station "+str(self.station_id))
        this_value = { "station_id": str(self.station_id),
        ...
        logger.info("Value to post: "+str(this_value))
